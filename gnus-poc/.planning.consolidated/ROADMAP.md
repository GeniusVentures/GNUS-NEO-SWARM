...
- [ ] **Phase 3: FP4 Quantization & Artifact Integrity** — Standards-compliant SGFP4 export with dual-mode selection and provenance manifests
...
**Goal**: SGFP4 export produces standards-compliant quantized models with 64x64 macroblocks, dual-mode per-block selection (FP4_AFFINE/T158_AFFINE), and provenance manifests.
